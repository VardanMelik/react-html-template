...
function App() {
  return (
    ...
    <section id="first">
        ...
        <div className="content">
            <p><strong>Lorem ipsum dolor</strong> sit amet consectetur adipiscing elit. Duis dapibus rutrum facilisis. className aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Etiam tristique libero eu nibh porttitor
            ...
            <ul className="items">
                ...
                <li>
                    ...
                    <ul className="icons">
                        ...
                        <li><a href="#" className="icon fa-codepen"><span className="label">Codepen</span></a></li>
                    </ul>
                </li>
            </ul>
        </footer>
    ...
    <div className="copyright">&copy; Untitled. All rights reserved. Design: <a href="https://eyemotion.me">Eye Motion, Global Gaming</a>.</div>
